        ...
        <ScrollView
          ...
          <View
            ...
            <View style={styles.viewStyleOne}>
              ...
              <Text style={styles.buttonTitleStyle}>Part 1</Text>
              <Text style={styles.buttonTextStyle}>Mô Tả</Text>
              <Text style={styles.buttonTextStyle}>Hình Ảnh</Text>
            </View>
            <View style={styles.viewStyleOne}>
              <TouchableOpacity
                style={{
              ...
              <Text style={styles.buttonTitleStyle}>Part 2</Text>
              <Text style={styles.buttonTextStyle}>Hỏi &</Text>
              <Text style={styles.buttonTextStyle}>Đáp</Text>
            </View>
            <View style={styles.viewStyleOne}>
              <TouchableOpacity
                style={{
              ...
              <Text style={styles.buttonTitleStyle}>Part 3</Text>
              <Text style={styles.buttonTextStyle}>Đoạn</Text>
              <Text style={styles.buttonTextStyle}>Hội Thoại</Text>
            </View>
            <View style={styles.viewStyleOne}>
              <TouchableOpacity
                style={{
              ...
              <Text style={styles.buttonTitleStyle}>Part 4</Text>
              <Text style={styles.buttonTextStyle}>Chuyện</Text>
              <Text style={styles.buttonTextStyle}>Ngắn</Text>
            </View>
          </View>
          ...
          <View
            ...
            <View style={styles.viewStyleOne}>
              ...
              <Text style={styles.buttonTitleStyle}>Part 5</Text>
              <Text style={styles.buttonTextStyle}>Điền</Text>
              <Text style={styles.buttonTextStyle}>Vào Câu</Text>
            </View>
            <View style={styles.viewStyleOne}>
              <TouchableOpacity
                style={{
              ...
              <Text style={styles.buttonTitleStyle}>Part 6</Text>
              <Text style={styles.buttonTextStyle}>Điền Vào</Text>
              <Text style={styles.buttonTextStyle}>Đoạn Văn</Text>
            </View>
            <View style={styles.viewStyleOne}>
              <TouchableOpacity
                style={{
              ...
              <Text style={styles.buttonTitleStyle}>Part 7</Text>
              <Text style={styles.buttonTextStyle}>Đọc Hiểu</Text>
              <Text style={styles.buttonTextStyle}>Đoạn Văn</Text>
            </View>
            <View style={styles.viewStyleOne}></View>
          </View>

          <Text style={styles.loaitext}>Thi thử</Text>
          <View
            style={{
              flex: 1,
              flexDirection: 'row',
            ...
            <View style={styles.viewStyleOne}>
              ...
              <Text style={styles.buttonTitleStyle}>Thi Thử</Text>
            </View>
            <View style={styles.viewStyleOne}>
              {/* <TouchableOpacity
